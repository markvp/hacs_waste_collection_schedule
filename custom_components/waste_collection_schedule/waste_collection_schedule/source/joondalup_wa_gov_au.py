...
PARAM_DESCRIPTIONS = {  # Optional dict to describe the arguments, will be shown in the GUI configuration below the respective input field
    "en": {
        "number": "Your house number as it appears on the Joondalup website",
        "street": "Your street name as it appears on the Joondalup website",
        "suburb": "Your suburb as it appears on the Joondalup website",
        "mapkey": "The unique identifier for your property used by the Joondalup website",
    },
}
